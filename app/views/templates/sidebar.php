<style>
    ...
    <div class="sidenav">
        ...
        <?php if ($_SESSION['id_role'] == 1) { ?>
            ...
            <a href="hardian-master-pelanggan.php">
            ...
            <a href="hardian-master-menu.php">
        ...
        <?php } ?>
        <a href="<?= BASEURL?>/logout"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-left" viewBox="0 0 16 16">
